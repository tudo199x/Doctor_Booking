...
@if(Route::is('appointment.check'))
   <form action="{{route('update')}}" method="post">@csrf
    <div class="card">
        <div class="card-header">
            Chọn Giờ Hẹn Buổi Sáng
           <span style="margin-left: 700px">Kiểm tra / Bỏ chọn
...
@else 
<h3>Danh Sách Thời Gian Cuộc Hẹn Của Bạn: {{$myappointments->count()}}</h3>

        <table class="table table-striped">
          <thead>
            <tr>
              <th scope="col">#</th>
              <th scope="col">Người Tạo Cuộc Hẹn</th>
              <th scope="col">Thời Gian</th>
              <th scope="col">Xem/Sửa Đổi</th>
            </tr>
          </thead>
          <tbody>
            ...
            <tr>
              ...
              <td>
                    ...
                    <button type="submit" class="btn btn-primary">Xem/Sửa Đổi</button>
